...
import { Brain, Settings, Network, Plus } from "lucide-react";
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center space-x-2">
            ...
            <Badge variant="outline" className="ml-2">Multi-LLM Ready</Badge>
          </CardTitle>
          <CardDescription>
            Design and deploy your custom AI white-collar employee with advanced multi-model collaboration capabilities.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Tabs defaultValue="basic" className="space-y-6">
            <TabsList className="grid w-full grid-cols-3">
              ...
              <TabsTrigger value="multi-llm" className="flex items-center space-x-2">
              ...
              <div className="space-y-4">
                ...
                {formData.useMultiLLM && (
                  <MultiLLMConfigurator 
                    ...
                    onChange={handleMultiLLMConfigChange}
                  />
                )}
                  ...
                  <Card className="border-dashed">
                    <CardContent className="flex items-center justify-center py-12">
                      <div className="text-center">
                        ...
                        <h3 className="text-lg font-medium text-gray-500 mb-2">Multi-LLM Collaboration</h3>
                        <p className="text-gray-400 mb-4">
                          Enable multiple AI models to collaborate on tasks for enhanced performance and reliability
                        </p>
                        <Label htmlFor="use-multi-llm" className="cursor-pointer">
                          <Button variant="outline" onClick={() => handleInputChange('useMultiLLM', true)}>
                            Enable Multi-LLM
                          </Button>
                        </Label>
                      </div>
          ...
          <div className="pt-4 border-t">
            <div className="flex justify-between items-center">
              <div className="text-sm text-gray-500">
                Estimated training time: {formData.useMultiLLM ? '5-10 minutes' : '2-5 minutes'}
                {formData.useMultiLLM && (
